...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.closeButton.setMinimumSize(QtCore.QSize(25, 35))
        self.closeButton.setMaximumSize(QtCore.QSize(25, 35))
...
"}")
        ...
        self.moreButton.setMinimumSize(QtCore.QSize(25, 35))
        self.moreButton.setMaximumSize(QtCore.QSize(25, 35))
        font = QtGui.QFont()
        font.setPointSize(30)
        font.setBold(True)
        font.setWeight(75)
