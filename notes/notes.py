...
if __name__ == '__main__':
    app = QApplication([])
    app.setApplicationName("Note Pad")
    app.setStyle("Fusion")

    # Custom brown palette.
    palette = QPalette()
    palette.setColor(QPalette.Window, QColor(200,200,120))
    palette.setColor(QPalette.WindowText, QColor(15,15,15))
    palette.setColor(QPalette.ButtonText, QColor(15,15,15))
    palette.setColor(QPalette.Text, QColor(15,15,15))
    palette.setColor(QPalette.Base, QColor(200,200,28))
    palette.setColor(QPalette.AlternateBase, QColor(188,172,164))
